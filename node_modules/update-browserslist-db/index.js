...
BrowserslistUpdateError.prototype = Object.create(Error.prototype)
BrowserslistUpdateError.prototype.constructor = BrowserslistUpdateError
...
function getBrowsers() {
  ...
  return browserslist().reduce((result, entry) => {
    let [browser, version] = entry.split(' ')
    if (!result[browser]) {
      result[browser] = []
    }
    result[browser].push(version)
    return result
  }, {})
}
